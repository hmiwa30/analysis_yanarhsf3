...
"yanarhs_f3_analysis_0814_part1.2"

prefix = NULL
my_f2_dir = NULL

(prefix = sprintf("%s\\yanarhs_f3_analysis_altai_part1.2",sdir))
...
write.table(dat.f3,sprintf("%s\\yanarhs_f3_analysis_0814_altai_part1.2.f3_FIN.txt",rdir),quote=F,row.names=F)
...
(prefix = sprintf("%s\\yanarhs_f3_analysis_chagyrskaya_part1.2",sdir))
...
(pop3 = as.character(lista[-13]))
dat.f3=f3(f2_blocks,pop1,pop2,pop3)
write.table(dat.f3,sprintf("%s\\yanarhs_f3_analysis_0814_chagyrskaya_part1.2.f3_FIN.txt",rdir),quote=F,row.names=F)
...
(prefix = sprintf("%s\\yanarhs_f3_analysis_denisova_part1.2",sdir))
...
(pop3 = as.character(lista[-13]))
dat.f3=f3(f2_blocks,pop1,pop2,pop3)
write.table(dat.f3,sprintf("%s\\yanarhs_f3_analysis_0814_denisova_part1.2.f3_FIN.txt",rdir),quote=F,row.names=F)
...
(prefix = sprintf("%s\\yanarhs_f3_analysis_vindija_part1.2",sdir))
...
(pop3 = as.character(lista[-13]))
dat.f3=f3(f2_blocks,pop1,pop2,pop3)
write.table(dat.f3,sprintf("%s\\yanarhs_f3_analysis_0814_vindija_part1.2.f3_FIN.txt",rdir),quote=F,row.names=F)
