...
(prefix = sprintf("%s\\debug03_yana_j_f3_analysis_altai",sdir))
(my_f2_dir = sprintf("%s\\debug03_yana_j_f3_analysis_altai",rdir))
...
write.table(dat.f3,sprintf("%s\\debug03_yana_j_f3_analysis_altai.f3_FIN.txt",rdir),quote=F,row.names=F)
