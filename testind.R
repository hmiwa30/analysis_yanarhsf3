...
write.table(df1,"analysis_yanarhsf3/test.ind",quote=F,col.names=F,row.names=F)
write.table(df1,"analysis_yanarhsf3/yanarhsf3/test.ind",quote=F,col.names=F,row.names=F)
write.table(df1,"analysis_yanarhsf3/yanarhs_jomonf3/test.ind",quote=F,col.names=F,row.names=F)